...
) # this is basically borrowing a single box everytime
...
```{r}    
# for loop
month_names <- char_storage <- vector("character", length = 12)
for (month in month.name) {
    char_storage[i] <- month_names}
